...
required_ski_thickness = np.sqrt(6 / yield_strength_aluminium / rear_ski_width * maximum_moment) # m
...
leg_normal_force = np.cos(drag_angle) * deceleration_g * G + np.cos(normal_angle) * landing_g * G * SF # N
